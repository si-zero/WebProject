...
import { LoadingProvider } from "./context/LoadingContext"; // ✅ 추가
import GlobalLoading from "./components/GlobalLoading";     // ✅ 추가
        ...
        <LikedStoreProvider>
          <Router>
            ...
            <Routes>
              ...
              <Route path="/edit-product" element={<AddOrEditProductPage />} />
